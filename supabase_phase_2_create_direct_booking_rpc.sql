-- ============================================================================
-- 157 TATTOO — PHASE 2 MIGRATION: DIRECT BOOKING ATOMIC RPC
-- Server-side RPC for Direct Booking Flow (Atomic intake + booking creation)
-- ============================================================================

BEGIN;

-- 1. Update insert defaults trigger function to support DIRECT_BOOKING deposit
...
BEGIN
  ...
  IF NEW.request_type = 'DIRECT_BOOKING' THEN
    NEW.deposit_required := COALESCE(NEW.deposit_required, 500.00);
  ELSE
...
-- 2. Create Canonical RPC: create_direct_booking_request
...
BEGIN
  ...
  -- 7. Insert Intake Record into public.estimate_requests
...
-- 3. Hardened Function Permissions
