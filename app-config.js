...
const SUPABASE_URL = "https://douygxbizmkcbonmewbw.supabase.co/rest/v1/"; // ป้อน Supabase Project URL ที่นี่ เช่น "https://xxxx.supabase.co"
const SUPABASE_ANON_KEY = "sb_publishable_0xFDmwYwu5XQo1uOQ8F73A_yolkhpYh"; // ป้อน Supabase Anon API Key ที่นี่
const GEMINI_API_KEY = "AQ.Ab8RN6J4clfLiigktaDX8v5KyY1t2FoXcPQsvW9Ttmgphpa0qA"; // ป้อน Google AI Studio API Key ที่นี่ (สำหรับใช้ระบบวิเคราะห์ลายสักและดูแลแผลสักด้วย AI)
