-- Drop NOT NULL constraint on expires_at
ALTER TABLE public.shop_invites ALTER COLUMN expires_at DROP NOT NULL;

-- Update existing pending invites to never expire
