-- Migration: Bypass artist tattoo style capability check for Flash Bookings
-- File: supabase/migrations/20260830050000_bypass_artist_style_check_for_flash.sql
...
BEGIN
    ...
    -- Style support check (Bypass for Flash Bookings - when p_flash_design_id is NOT NULL)
    IF p_flash_design_id IS NULL AND p_style_id IS NOT NULL AND NOT EXISTS (
