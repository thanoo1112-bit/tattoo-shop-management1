-- Migration: Fix Mode A deposit holds and payment generation
-- File: supabase/migrations/20260830111000_fix_mode_a_deposit_holds.sql
...
BEGIN
    ...
    -- If it is Mode A, handle payments/holds/appointments
    IF v_mode_val = 'fixed_price' THEN
        IF v_initial_status = 'pending_payment' THEN
            -- Create 24-hour hard schedule hold
        ...
        ELSIF v_initial_status = 'approved' THEN
            -- Create appointment immediately
            INSERT INTO public.appointments (
                shop_id, project_id, booking_request_id, customer_id, artist_id, session_number, start_at, end_at, status, created_by
            )
            VALUES (
                v_session.shop_id, v_project_id, v_booking_id, v_customer_id, v_session.artist_id, 1, v_requested_start_at, v_requested_end_at, 'scheduled', NULL
            );
        END IF;
    END IF;
