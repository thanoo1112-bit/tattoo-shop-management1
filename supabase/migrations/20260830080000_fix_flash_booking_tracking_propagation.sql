-- Migration: Fix Flash Booking tracking propagation and add Flash fields to public bookings RPC
-- File: supabase/migrations/20260830080000_fix_flash_booking_tracking_propagation.sql

-- 1. Redefine finalize_public_booking to correctly propagate placement, dimensions, color mode, style name, price, flash ID, etc.
...
BEGIN
    ...
    -- Fallback to style_name from flash_designs if style_id was null
    ...
    -- Insert project with all necessary details propagated from booking payload
    INSERT INTO public.tattoo_projects (
        ...
        agreed_price, flash_design_id, flash_variant_id
    )
    VALUES (
        ...
        v_flash_price, p_flash_design_id, p_flash_variant_id
    )
...
-- 2. Drop and recreate get_public_bookings_by_phone to return flash_design_id, flash_code, and flash_style
