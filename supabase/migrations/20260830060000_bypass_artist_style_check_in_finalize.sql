-- Migration: Bypass artist tattoo style capability check in finalize_public_booking for Flash Bookings
-- File: supabase/migrations/20260830060000_bypass_artist_style_check_in_finalize.sql
