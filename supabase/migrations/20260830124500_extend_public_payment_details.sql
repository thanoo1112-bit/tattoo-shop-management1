-- 1. Redefine get_public_payment_details to return extended fields for data display in payment UI
...
BEGIN
    ...
    RETURN json_build_object(
        ...
        -- Extended fields for UI data display
        ...
        'flash_code', COALESCE(v_flash.flash_code, NULL),
        'flash_image_path', COALESCE(v_flash.image_path, NULL)
    );
END;
$$;
