-- =============================================================================
-- Finalize booking auth required migration
-- Replaces customers insertion in finalize_public_booking with ensure_customer_account.
-- =============================================================================
...
BEGIN
    ...
    IF v_uid IS NULL THEN
        RAISE EXCEPTION 'Authentication required to finalize booking';
    END IF;
    ...
    -- HERE: Resolve customer_id with ensure_customer_account (utilising auth.uid())
    v_customer_id := public.ensure_customer_account(v_session.shop_id, p_full_name, p_phone, v_email_val);
